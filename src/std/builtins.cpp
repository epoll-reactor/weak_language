...
boost::intrusive_ptr<ast::Object> default_typecheck(const std::string& fun_name, const std::vector<boost::intrusive_ptr<ast::Object>>& arguments)
{
    if (arguments.size() != 1) { throw EvalError(fun_name + ": 1 argument required, got " + std::to_string(arguments.size())); }

    return new ast::Integer(static_cast<bool>(boost::dynamic_pointer_cast<TargetType>(arguments[0])));
}

const std::unordered_map<std::string, builtin_function_t> builtins
{
    {"integer?", [](const std::vector<boost::intrusive_ptr<ast::Object>>& arguments) {

        return default_typecheck<ast::Integer>("integer?", arguments);
    }},
    {"float?", [](const std::vector<boost::intrusive_ptr<ast::Object>>& arguments) {

        return default_typecheck<ast::Float>("float?", arguments);
    }},
    {"string?", [](const std::vector<boost::intrusive_ptr<ast::Object>>& arguments) {

        return default_typecheck<ast::String>("string?", arguments);
    }},
    {"array?", [](const std::vector<boost::intrusive_ptr<ast::Object>>& arguments) {

        return default_typecheck<ast::Array>("array?", arguments);
    }},
    {"procedure?", [](const std::vector<boost::intrusive_ptr<ast::Object>>& arguments) {

        return default_typecheck<ast::Function>("procedure?", arguments);
    }},
    {"procedure-arity", [](const std::vector<boost::intrusive_ptr<ast::Object>>& arguments) {
        ...
        return new ast::Integer(boost::static_pointer_cast<ast::Function>(arguments[0])->arguments().size());
    }},
    {"print", [](const std::vector<boost::intrusive_ptr<ast::Object>>& arguments) {
    ...
    {"println", [](const std::vector<boost::intrusive_ptr<ast::Object>>& arguments) {
